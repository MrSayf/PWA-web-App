  ...
  <body>
    ...
    <main class="main-wrap product-page mb-xxl">
      ...
      <section class="product-review pb-0">
        <div class="top-content">
          ...
          <a href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#all-review" class="font-xs">See all</a>
        </div>
        <div class="review-wrap">
          <div class="review-box">
            <div class="media">
      ...
      <section class="check-delivery-section">
        ...
        <div class="service-section">
          <ul>
            <li class="font-sm content-color"><img src="assets/icons/svg/delivery.svg" class="img-fluid" alt="" />Free Delivery on order above $200.00</li>
            <li class="font-sm content-color"><img src="assets/icons/svg/payment.svg" class="img-fluid" alt="" />Cash On delivery Available</li>
            <li class="font-sm content-color"><img src="assets/icons/svg/refund.svg" class="img-fluid" alt="" />Easy 21 days returns and exchanges</li>
          </ul>
        </div>
      </section>
        ...
        <div class="product-slider">
          <div>
            <div class="product-card">
              <div class="img-wrap">
                <a href="product.php"><img src="assets/images/product/10.png" class="img-fluid" alt="product" /> </a>
              </div>
              <div class="content-wrap">
                <a href="product.php" class="font-sm title-color">Assorted Capsicum Combo </a>
          ...
          <div>
            <div class="product-card">
              <div class="img-wrap">
                <a href="product.php"><img src="assets/images/product/11.png" class="img-fluid" alt="product" /> </a>
              </div>
              <div class="content-wrap">
                <a href="product.php" class="font-sm title-color">Assorted Capsicum Combo </a>
                <span class="content-color font-xs">500g</span>
          ...
          <div>
            <div class="product-card">
              <div class="img-wrap">
                <a href="product.php"><img src="assets/images/product/12.png" class="img-fluid" alt="product" /> </a>
              </div>
              <div class="content-wrap">
                <a href="product.php" class="font-sm title-color">Assorted Capsicum Combo </a>
                <span class="content-color font-xs">500g</span>
          ...
          <div>
            <div class="product-card">
              <div class="img-wrap">
                <a href="product.php"><img src="assets/images/product/13.png" class="img-fluid" alt="product" /> </a>
              </div>
              <div class="content-wrap">
                <a href="product.php" class="font-sm title-color">Assorted Capsicum Combo </a>
                <span class="content-color font-xs">500g</span>
          ...
          <div>
            <div class="product-card">
              <div class="img-wrap">
                <a href="product.php"><img src="assets/images/product/9.png" class="img-fluid" alt="product" /> </a>
              </div>
              <div class="content-wrap">
                <a href="product.php" class="font-sm title-color">Assorted Capsicum Combo </a>
                <span class="content-color font-xs">500g</span>
    ...
    <footer class="footer-wrap shop">
      <ul class="footer">
        ...
        <li class="footer-item">
          <a href="cart.php" class="font-md">Add to Cart <i data-feather="chevron-right"></i></a>
        </li>
      </ul>
    </footer>
    <!-- Footer End -->
...
<!-- Mirrored from themes.pixelstrap.com/fastkart-app/product.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Feb 2023 10:53:34 GMT -->
</html>
<!-- Html End -->
